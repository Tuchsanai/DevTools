...
cd DevTools/03_Application_Docker/03_Traefik_Reverse_Proxy_Gateway_LB
```
...
```bash
cd ~/labwork/DevTools/03_Application_Docker/03_Traefik_Reverse_Proxy_Gateway_LB/<โฟลเดอร์แล็บ>
docker compose down
