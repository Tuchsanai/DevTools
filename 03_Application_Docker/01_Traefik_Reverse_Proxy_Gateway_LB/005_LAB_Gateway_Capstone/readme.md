...
cd DevTools/03_Application_Docker/01_Traefik_Reverse_Proxy_Gateway_LB/005_LAB_Gateway_Capstone
chmod +x check.sh
```
...
| **AC3** | orders กระจายโหลด | ยิง 12 ครั้ง **ทุกครั้งต้องสำเร็จ** และพบอย่างน้อย 2 hostname |
