...
| ขั้น | ทำอะไร | ผลลัพธ์ที่ตรวจได้ | สไลด์ |
|---|---|---|---|
| 1 · Start | สร้าง network และคอนเทนเนอร์ Jenkins | `jenkins` ทำงานบน `cicd-net` | ขั้นที่ 0–2 |
| 2 · Verify | ตรวจสถานะและ log ของคอนเทนเนอร์ | สถานะ `Up` และเริ่มระบบเสร็จ | ขั้นที่ 3–4 |
| 3 · Access | อ่านรหัสปลดล็อกแล้วเปิดหน้าเว็บ | เข้าหน้า Unlock ที่พอร์ต 8080 ได้ | ขั้นที่ 3–4 |
| 4 · Configure | ติดตั้ง plugin และสร้างผู้ดูแล | เข้าใช้งานด้วย `admin` ได้ | ขั้นที่ 5 |
| 5 · Test | สร้างและรัน job แรก | build แรกจบด้วย `SUCCESS` | ขั้นที่ 6 |
| 6 · Verify state | restart แล้วรันสคริปต์ตรวจผล | `LAB 1 CHECK: PASS` | ขั้นที่ 7 |
