...
![ตัวอย่าง Web UI สีสันสดใส 6 หน้าจอของ Pet Clinic Booking](images/pet-clinic-wireframe-example.png)

[เปิดตัวอย่าง Wireframe แบบ HTML](pet-clinic-wireframe-example.html)

ตัวอย่างออกแบบเป็น Web UI แบบ High Fidelity จำนวน 6 หน้า โดยทุกหน้าต้องตรงกับ User Flow:
...
ตัวอย่างนี้ทำให้ดูเหมือนเว็บจริงเพื่อให้นักศึกษาเห็นปลายทางของงานออกแบบ แต่ผลงานที่ส่งยังใช้ Wireframe แบบเรียบง่ายได้ สิ่งสำคัญคือข้อมูล ปุ่ม และทางไปหน้าถัดไปต้องชัดเจน
