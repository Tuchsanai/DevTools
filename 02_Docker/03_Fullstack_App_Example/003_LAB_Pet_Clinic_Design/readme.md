...
ทุกแบบเป็น Wireframe เพื่อสื่อแนวคิด ไม่จำเป็นต้องเชื่อมฐานข้อมูลหรือพัฒนาเป็นระบบที่ใช้งานจริง

## สิ่งที่ต้องส่ง

1. **User Flow** — แสดงลำดับตั้งแต่ผู้ใช้เริ่มจองจนเห็นผลยืนยัน พร้อมชื่อหน้าจอและ Action ในแต่ละขั้น
2. **Wireframe ของหน้าจอใน Flow** — เห็นข้อมูลที่ต้องแสดงหรือกรอก ปุ่มหลัก และทางไปหน้าถัดไป ส่งเป็นภาพถ่ายจากกระดาษ ภาพที่สร้างด้วยเครื่องมือดิจิทัล/AI หรือไฟล์ HTML ที่ AI ช่วยสร้างก็ได้
